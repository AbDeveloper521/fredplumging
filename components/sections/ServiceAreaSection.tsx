  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="none"
        stroke="rgb(234 48 56 / 0.55)"
        strokeWidth="2.5"
        strokeDasharray="1 7"
        strokeLinecap="round"
      />
      {/* Coverage radius */}
      <circle cx="262" cy="200" r="130" fill="none" stroke="rgb(234 48 56 / 0.2)" strokeWidth="1.5" />
      <circle cx="262" cy="200" r="88" fill="none" stroke="rgb(234 48 56 / 0.3)" strokeWidth="1.5" strokeDasharray="4 6" />

      {/* Fort Worth marker */}
      <g transform="translate(150 210)">
        <circle r="22" fill="rgb(234 48 56 / 0.12)" />
        <circle r="7" fill="#EA3038" />
      ...
      <g transform="translate(370 195)">
        <circle r="26" fill="rgb(234 48 56 / 0.14)" />
        <circle r="8" fill="#EA3038" />
