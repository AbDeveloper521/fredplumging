...
export type HydroJettingPage = {
  _id: string;
  _type: "hydroJettingPage";
  _createdAt: string;
  _updatedAt: string;
  _rev: string;
  sections?: Array<
...
// Source: sanity/queries.ts
// Variable: HYDRO_JETTING_PAGE_QUERY
// Query: *[_type == "hydroJettingPage" && _id == "hydroJettingPage"][0]{    sections[]{    ...,    photo{ asset, hotspot, crop, alt, frameRatio },    photoPrimary{ asset, hotspot, crop, alt, frameRatio },    photoSecondary{ asset, hotspot, crop, alt },    primaryPhoto{ asset, hotspot, crop, alt, frameRatio },    secondaryPhoto{ asset, hotspot, crop, alt },    faqSet->{ heading, intro, items[]{ _key, question, answer } }  }  }
export type HYDRO_JETTING_PAGE_QUERY_RESULT = {
  sections: Array<
    | {
        _key: string;
        _type: "aboutEvolution";
